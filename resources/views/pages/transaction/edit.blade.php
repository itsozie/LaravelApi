...
<div class="card">
    ...
    <div class="card-body card-block">
        ...
        <div class="form-group">
            <label for="type" class="form-control-label">Email Pemesan</label>
        ...
        <div class="form-group">
            <label for="quantity" class="form-control-label">Nomor Pemesan</label>
        ...
        <div class="form-group">
            <label for="quantity" class="form-control-label">Alamat Pemesan</label>
